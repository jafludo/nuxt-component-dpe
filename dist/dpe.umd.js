(function (global, factory) {
    ...
    var script = {
        ...
        data: function data() {
            return {
                dpe: [
                    { text: "≤ 50", letter: "A", color: "#319834", width: '35%', colortext: 'black', minrange: 0, maxrange: 50, min: 0, index: 0 },
                    { text: "51 à 90", letter: "B", color: "#33cc31", width: '45%', colortext: 'black', minrange: 51, maxrange: 90, min: '2.25rem', index: 1 },
                    { text: "91 à 150", letter: "C", color: "#cbfc34", width: '55%', colortext: 'black', minrange: 91, maxrange: 150, min: '4.5rem', index: 2 },
                    { text: "151 à 230", letter: "D", color: "#fbfe06", width: '65%', colortext: 'black', minrange: 151, maxrange: 230, min: '6.75rem', index: 3 },
                    { text: "231 à 330", letter: "E", color: "#fbcc05", width: '75%', colortext: 'black', minrange: 231, maxrange: 330, min: '9rem', index: 4 },
                    { text: "331 à 450", letter: "F", color: "#fc9935", width: '85%', colortext: 'black', minrange: 331, maxrange: 450, min: '11.25rem', index: 5 },
                    { text: "> 450", letter: "G", color: "#fc0205", width: '100%', colortext: 'white', minrange: 450, maxrange: 9999999999, min: '13.5rem', index: 6 } ],
                dpeTertiaire: [
                    { text: "≤ 50", letter: "A", color: "#319834", width: '34%', colortext: 'black', minrange: 0, maxrange: 50, min: 0, index: 0 },
                    { text: "51 à 90", letter: "B", color: "#33cc31", width: '41%', colortext: 'black', minrange: 51, maxrange: 90, min: '2.25rem', index: 1 },
                    { text: "91 à 150", letter: "C", color: "#cbfc34", width: '48%', colortext: 'black', minrange: 91, maxrange: 150, min: '4.5rem', index: 2 },
                    { text: "150 à 230", letter: "D", color: "#fbfe06", width: '56%', colortext: 'black', minrange: 150, maxrange: 230, min: '6.75rem', index: 3 },
                    { text: "231 à 330", letter: "E", color: "#fbcc05", width: '64%', colortext: 'black', minrange: 231, maxrange: 330, min: '9rem', index: 4 },
                    { text: "331 à 450", letter: "F", color: "#fc9935", width: '71%', colortext: 'black', minrange: 331, maxrange: 450, min: '11.25rem', index: 5 },
                    { text: "451 à 590", letter: "G", color: "#fc0205", width: '78%', colortext: 'black', minrange: 451, maxrange: 590, min: '13.5rem', index: 6 },
                    { text: "591 à 750", letter: "H", color: "#4d4d4d", width: '85%', colortext: 'black', minrange: 591, maxrange: 750, min: '15.75rem', index: 7 },
                    { text: "> 750", letter: "I", color: "#000000", width: '100%', colortext: 'white', minrange: 750, maxrange: 9999999999, min: '18rem', index: 8 } ],
                dpePublic: [
                    { text: "≤ 30", letter: "A", color: "#319834", width: '35%', colortext: 'black', minrange: 0, maxrange: 30, min: 0, index: 0 },
                    { text: "31 à 90", letter: "B", color: "#33cc31", width: '45%', colortext: 'black', minrange: 51, maxrange: 90, min: '2.25rem', index: 1 },
                    { text: "91 à 170", letter: "C", color: "#cbfc34", width: '55%', colortext: 'black', minrange: 91, maxrange: 170, min: '4.5rem', index: 2 },
                    { text: "171 à 270", letter: "D", color: "#fbfe06", width: '65%', colortext: 'black', minrange: 171, maxrange: 270, min: '6.75rem', index: 3 },
                    { text: "271 à 380", letter: "E", color: "#fbcc05", width: '75%', colortext: 'black', minrange: 271, maxrange: 380, min: '9rem', index: 4 },
                    { text: "381 à 510", letter: "F", color: "#fc9935", width: '85%', colortext: 'black', minrange: 381, maxrange: 510, min: '11.25rem', index: 5 },
                    { text: "> 510", letter: "G", color: "#fc0205", width: '100%', colortext: 'white', minrange: 510, maxrange: 9999999999, min: '13.5rem', index: 6 } ],
                dpeBureaux: [
                    { text: "≤ 50", letter: "A", color: "#319834", width: '35%', colortext: 'black', minrange: 0, maxrange: 50, more: 0, min: 0, index: 0 },
                    { text: "51 à 110", letter: "B", color: "#33cc31", width: '45%', colortext: 'black', minrange: 51, maxrange: 110, min: '2.25rem', index: 1 },
                    { text: "111 à 210", letter: "C", color: "#cbfc34", width: '55%', colortext: 'black', minrange: 111, maxrange: 210, min: '4.5rem', index: 2 },
                    { text: "211 à 350", letter: "D", color: "#fbfe06", width: '65%', colortext: 'black', minrange: 211, maxrange: 350, min: '6.75rem', index: 3 },
                    { text: "351 à 540", letter: "E", color: "#fbcc05", width: '75%', colortext: 'black', minrange: 351, maxrange: 540, min: '9rem', index: 4 },
                    { text: "541 à 750", letter: "F", color: "#fc9935", width: '85%', colortext: 'black', minrange: 541, maxrange: 750, min: '11.25rem', index: 5 },
                    { text: "> 750", letter: "G", color: "#fc0205", width: '100%', colortext: 'white', minrange: 750, maxrange: 9999999999, min: '13.5rem', index: 6 } ],
                dpeOccContinue: [
                    { text: "≤ 100", letter: "A", color: "#319834", width: '35%', colortext: 'black', minrange: 0, maxrange: 100, min: 0, index: 0 },
                    { text: "101 à 210", letter: "B", color: "#33cc31", width: '45%', colortext: 'black', minrange: 101, maxrange: 210, min: '2.25rem', index: 1 },
                    { text: "211 à 370", letter: "C", color: "#cbfc34", width: '55%', colortext: 'black', minrange: 211, maxrange: 370, min: '4.5rem', index: 2 },
                    { text: "371 à 580", letter: "D", color: "#fbfe06", width: '65%', colortext: 'black', minrange: 371, maxrange: 580, min: '6.75rem', index: 3 },
                    { text: "581 à 830", letter: "E", color: "#fbcc05", width: '75%', colortext: 'black', minrange: 581, maxrange: 830, min: '9rem', index: 4 },
                    { text: "831 à 1130", letter: "F", color: "#fc9935", width: '85%', colortext: 'black', minrange: 831, maxrange: 1130, min: '11.25rem', index: 5 },
                    { text: "> 1130", letter: "G", color: "#fc0205", width: '100%', colortext: 'white', minrange: 1130, maxrange: 9999999999, min: '13.5rem', index: 6 } ],
                assocDPE: [
        ...
        mounted: function mounted() {
            ...
            this.type ? this.dpe = this[dpefind.ref] : this.dpe;
            var heightCell = (document.getElementById('dpe_div').offsetHeight / this[dpefind.ref].length) - 12;
            ...
            var DynamicHeight = (dperange.index * heightCell) + 4 * dperange.index;
            var r = document.querySelector(':root');
            r.style.setProperty('--heightDPE', DynamicHeight + 'px');
            r.style.setProperty('--heightCell', heightCell + 'px');
            r.style.setProperty('--heightTriangle', heightCell / 2 + 'px');
                    ...
                    _c(
                      ...
                      [
                        _c(
                          ...
                          {
                            style:
                              "color : " + e.colortext + " ; padding-left: 8px",
                          },
                        ...
                        _c(
                          ...
                          {
                            style:
                              "color : " + e.colortext + " ; padding-right: 8px",
                          },
    ...
    var script$1 = {
        ...
        mounted: function mounted() {
            ...
            this.type ? this.ges = this[gesfind.ref] : this.ges;
            var heightCell = (document.getElementById('ges_div').offsetHeight / this[gesfind.ref].length) - 12;
            ...
            var DynamicHeight = (gesrange.index * heightCell) + 4 * gesrange.index;
            var r = document.querySelector(':root');
    ...
    __vue_render__$1._withStripped = true;
      ...
      var __vue_inject_styles__$1 = function (inject) {
        if (!inject) { return }
        inject("data-v-b64fd248_0", { source: ":root {\n  --heightGES: 0px;\n  --heightCellGES: 2rem;\n  --heightTriangleGES: 1rem;\n}\n#ges_div {\n  position: relative;\n  max-height: fit-content;\n  height: fit-content;\n  width: 100%;\n  display: flex;\n}\n#ges_div .space_beetween {\n  height: var(--heightGES);\n}\n#ges_div .legend_top {\n  text-align: initial;\n}\n#ges_div .legend_bottom {\n  display: flex;\n  position: absolute;\n  justify-content: space-between;\n  width: 100%;\n}\n#ges_div .grp-et {\n  display: flex;\n}\n#ges_div .div_left {\n  width: 100%;\n  z-index: 5;\n}\n#ges_div .div_right {\n  display: flex;\n  flex-direction: column;\n  height: 100%;\n  position: relative;\n}\n#ges_div .slider_number {\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  background-color: black;\n  color: white;\n  width: 100%;\n  z-index: 2;\n}\n#ges_div .space_between_class {\n  padding: 2px 0px 2px 0px;\n}\n#ges_div * {\n  margin: 0;\n}\n#ges_div .etiquette .etiquette_base {\n  height: var(--heightCellGES);\n  display: flex;\n  align-items: center;\n  justify-content: space-between;\n  position: relative;\n  border: 1px solid;\n}\n#ges_div .triangle-leftcode {\n  border-top: var(--heightTriangle) solid transparent;\n  border-bottom: var(--heightTriangle) solid transparent;\n}\n#ges_div .aim_line {\n  height: 1px;\n  border-style: dotted;\n  border-color: black;\n  border-width: 1px;\n  position: absolute;\n  right: 0;\n  z-index: 1;\n}\n#ges_div .export_div {\n  cursor: pointer;\n  right: 0;\n}\n\n/*# sourceMappingURL=ges.vue.map */", map: {"version":3,"sources":["C:\\Users\\Ludo\\Desktop\\DEV\\nuxt-component-dpe\\src\\ges.vue","ges.vue"],"names":[],"mappings":"AAiKA;EACA,gBAAA;EACA,qBAAA;EACA,yBAAA;AChKA;ADqKA;EACA,kBAAA;EACA,uBAAA;EACA,mBAAA;EACA,WAAA;EACA,aAAA;AClKA;ADoKA;EACA,wBAAA;AClKA;ADqKA;EACA,mBAAA;ACnKA;ADsKA;EACA,aAAA;EACA,kBAAA;EACA,8BAAA;EACA,WAAA;ACpKA;ADuKA;EACA,aAAA;ACrKA;ADwKA;EACA,WAAA;EACA,UAAA;ACtKA;ADyKA;EACA,aAAA;EACA,sBAAA;EACA,YAAA;EACA,kBAAA;ACvKA;AD0KA;EACA,aAAA;EACA,mBAAA;EACA,uBAAA;EACA,uBAAA;EACA,YAAA;EACA,WAAA;EACA,UAAA;ACxKA;AD2KA;EACA,wBAAA;ACzKA;AD4KA;EACA,SAAA;AC1KA;AD8KA;EACA,4BAAA;EACA,aAAA;EACA,mBAAA;EACA,8BAAA;EACA,kBAAA;EACA,iBAAA;AC5KA;ADgLA;EACA,mDAAA;EACA,sDAAA;AC9KA;ADiLA;EACA,WAAA;EACA,oBAAA;EACA,mBAAA;EACA,iBAAA;EACA,kBAAA;EACA,QAAA;EACA,UAAA;AC/KA;ADkLA;EACA,eAAA;EACA,QAAA;AChLA;;AAEA,kCAAkC","file":"ges.vue","sourcesContent":["<template>\r\n    <div id=\"ges_div\" class=\"flex\">\r\n        <div class=\"div_left\">\r\n            <div class=\"legend_top\">\r\n                <p>{{ title_haut }}</p>\r\n            </div>\r\n            <div id='etiquette_ener' class=\"etiquette\">\r\n                <div v-for=\"(e, index) in ges\">\r\n                    <div class=\"grp-et\">\r\n                        <div class=\"etiquette_base\" :style=\"'background : ' + e.color + ' ; width: ' + e.width\">\r\n                            <p :style=\"'color : ' + e.colortext + ' ; padding-left: 8px'\">{{ e.text }}</p>\r\n                            <p :style=\"'color : ' + e.colortext + ' ; padding-right: 8px'\">{{ e.letter }}</p>\r\n                        </div>\r\n                    </div>\r\n                    <p class=\"space_between_class\"></p>\r\n                </div>\r\n                <div class=\"legend_bottom\">\r\n                    <p>{{ title_bas }}</p>\r\n                    <div class='export_div' v-if=\"exportMode == 'active'\" @click=\"exporttopng\">\r\n                        <svg xmlns=\"http://www.w3.org/2000/svg\" width=\"24\" height=\"24\" viewBox=\"0 0 24 24\">\r\n                            <g fill=\"none\" fill-rule=\"evenodd\">\r\n                                <path\r\n                                    d=\"M24 0v24H0V0h24ZM12.593 23.258l-.011.002l-.071.035l-.02.004l-.014-.004l-.071-.035c-.01-.004-.019-.001-.024.005l-.004.01l-.017.428l.005.02l.01.013l.104.074l.015.004l.012-.004l.104-.074l.012-.016l.004-.017l-.017-.427c-.002-.01-.009-.017-.017-.018Zm.265-.113l-.013.002l-.185.093l-.01.01l-.003.011l.018.43l.005.012l.008.007l.201.093c.012.004.023 0 .029-.008l.004-.014l-.034-.614c-.003-.012-.01-.02-.02-.022Zm-.715.002a.023.023 0 0 0-.027.006l-.006.014l-.034.614c0 .012.007.02.017.024l.015-.002l.201-.093l.01-.008l.004-.011l.017-.43l-.003-.012l-.01-.01l-.184-.092Z\" />\r\n                                <path fill=\"currentColor\"\r\n                                    d=\"M13.586 2a2 2 0 0 1 1.284.467l.13.119L19.414 7a2 2 0 0 1 .578 1.238l.008.176V12h-2v-2h-4.5a1.5 1.5 0 0 1-1.493-1.356L12 8.5V4H6v16h6v2H6a2 2 0 0 1-1.995-1.85L4 20V4a2 2 0 0 1 1.85-1.995L6 2h7.586Zm5.121 12.464l2.828 2.829a1 1 0 0 1 0 1.414l-2.828 2.828a1 1 0 1 1-1.414-1.414L18.414 19H14a1 1 0 1 1 0-2h4.414l-1.121-1.121a1 1 0 0 1 1.414-1.415ZM14 4.414V8h3.586L14 4.414Z\" />\r\n                            </g>\r\n                        </svg>\r\n                    </div>\r\n                    <div v-else></div>\r\n                </div>\r\n            </div>\r\n        </div>\r\n        <div class=\"div_right\">\r\n            <div class=\"legend_top_r\">\r\n                {{ typeBatiment }}\r\n            </div>\r\n            <div class=\"space_beetween\"></div>\r\n            <div class=\"grp-et\">\r\n                <div class=\"triangle-leftcode\" :style=\"'border-right: 24px solid black;'\"></div>\r\n                <div class=\"slider_number\">\r\n                    <p style=\"z-index: 8;\">{{ value }}</p>\r\n                    <div class=\"aim_line\" :style=\"'width: ' + this.widthDaron + 'px'\"></div>\r\n                </div>\r\n            </div>\r\n        </div>\r\n    </div>\r\n</template>\r\n<script lang=\"js\">\r\nimport * as htmlToImage from 'html-to-image';\r\nexport default {\r\n    name: 'ges',\r\n    props: ['value', 'exportMode', 'type'],\r\n    data() {\r\n        return {\r\n            ges: [\r\n                { text: \"≤ 5\", letter: \"A\", color: \"#f2eff4\", width: '30%', colortext: 'black', minrange: 0, maxrange: 5, min: 0, index: 0 },\r\n                { text: \"6 à 10\", letter: \"B\", color: \"#dfc1f7\", width: '40%', colortext: 'black', minrange: 6, maxrange: 10, min: 36, index: 1 },\r\n                { text: \"11 à 20\", letter: \"C\", color: \"#d6aaf4\", width: '50%', colortext: 'black', minrange: 11, maxrange: 20, min: 72, index: 2 },\r\n                { text: \"21 à 35\", letter: \"D\", color: \"#cc93f4\", width: '60%', colortext: 'black', minrange: 21, maxrange: 35, min: 108, index: 3 },\r\n                { text: \"36 à 55\", letter: \"E\", color: \"#bb72f3\", width: '70%', colortext: 'black', minrange: 36, maxrange: 55, min: 144, index: 4 },\r\n                { text: \"56 à 80\", letter: \"F\", color: \"#a94cee\", width: '80%', colortext: 'black', minrange: 56, maxrange: 80, min: 180, index: 5 },\r\n                { text: \"> 80\", letter: \"G\", color: \"#8b1ae1\", width: '90%', colortext: 'white', minrange: 80, maxrange: 9999, min: 216, index: 6 },\r\n            ],\r\n            gesTertiaire: [\r\n                { text: \"≤ 5\", letter: \"A\", color: \"#f2eff4\", width: '45%', colortext: 'black', minrange: 0, maxrange: 5, min: 0, index: 0 },\r\n                { text: \"6 à 10\", letter: \"B\", color: \"#dfc1f7\", width: '50%', colortext: 'black', minrange: 6, maxrange: 10, min: 36, index: 1 },\r\n                { text: \"11 à 20\", letter: \"C\", color: \"#d6aaf4\", width: '55%', colortext: 'black', minrange: 11, maxrange: 20, min: 72, index: 2 },\r\n                { text: \"21 à 35\", letter: \"D\", color: \"#cc93f4\", width: '60%', colortext: 'black', minrange: 21, maxrange: 35, min: 108, index: 3 },\r\n                { text: \"36 à 55\", letter: \"E\", color: \"#bb72f3\", width: '65%', colortext: 'black', minrange: 36, maxrange: 55, min: 144, index: 4 },\r\n                { text: \"56 à 80\", letter: \"F\", color: \"#a94cee\", width: '70%', colortext: 'black', minrange: 56, maxrange: 80, min: 180, index: 5 },\r\n                { text: \"81 à 110\", letter: \"G\", color: \"#8b1ae1\", width: '75%', colortext: 'white', minrange: 81, maxrange: 110, min: 216, index: 6 },\r\n                { text: \"111 à 145\", letter: \"H\", color: \"#4d4d4d\", width: '80%', colortext: 'white', minrange: 111, maxrange: 145, min: 252, index: 7 },\r\n                { text: \"> 145\", letter: \"I\", color: \"#000000\", width: '85%', colortext: 'white', minrange: 145, maxrange: 9999, min: 288, index: 8 },\r\n            ],\r\n            gesPublic: [\r\n                { text: \"≤ 3\", letter: \"A\", color: \"#f2eff4\", width: '30%', colortext: 'black', minrange: 0, maxrange: 3, min: 0, index: 0 },\r\n                { text: \"4 à 10\", letter: \"B\", color: \"#dfc1f7\", width: '40%', colortext: 'black', minrange: 4, maxrange: 10, min: 36, index: 1 },\r\n                { text: \"11 à 25\", letter: \"C\", color: \"#d6aaf4\", width: '50%', colortext: 'black', minrange: 11, maxrange: 25, min: 72, index: 2 },\r\n                { text: \"26 à 45\", letter: \"D\", color: \"#cc93f4\", width: '60%', colortext: 'black', minrange: 26, maxrange: 45, min: 108, index: 3 },\r\n                { text: \"46 à 70\", letter: \"E\", color: \"#bb72f3\", width: '70%', colortext: 'black', minrange: 46, maxrange: 70, min: 144, index: 4 },\r\n                { text: \"71 à 95\", letter: \"F\", color: \"#a94cee\", width: '80%', colortext: 'black', minrange: 71, maxrange: 95, min: 180, index: 5 },\r\n                { text: \"> 95\", letter: \"G\", color: \"#8b1ae1\", width: '90%', colortext: 'white', minrange: 95, maxrange: 9999, min: 216, index: 6 },\r\n            ],\r\n            gesBureaux: [\r\n                { text: \"≤ 5\", letter: \"A\", color: \"#f2eff4\", width: '30%', colortext: 'black', minrange: 0, maxrange: 5, min: 0, index: 0 },\r\n                { text: \"6 à 15\", letter: \"B\", color: \"#dfc1f7\", width: '40%', colortext: 'black', minrange: 6, maxrange: 15, min: 36, index: 1 },\r\n                { text: \"16 à 30\", letter: \"C\", color: \"#d6aaf4\", width: '50%', colortext: 'black', minrange: 16, maxrange: 30, min: 72, index: 2 },\r\n                { text: \"31 à 60\", letter: \"D\", color: \"#cc93f4\", width: '60%', colortext: 'black', minrange: 31, maxrange: 60, min: 108, index: 3 },\r\n                { text: \"61 à 100\", letter: \"E\", color: \"#bb72f3\", width: '70%', colortext: 'black', minrange: 61, maxrange: 100, min: 144, index: 4 },\r\n                { text: \"101 à 145\", letter: \"F\", color: \"#a94cee\", width: '80%', colortext: 'black', minrange: 101, maxrange: 145, min: 180, index: 5 },\r\n                { text: \"> 145\", letter: \"G\", color: \"#8b1ae1\", width: '90%', colortext: 'white', minrange: 145, maxrange: 9999, min: 216, index: 6 },\r\n            ],\r\n            gesOccContinue: [\r\n                { text: \"≤ 12\", letter: \"A\", color: \"#f2eff4\", width: '30%', colortext: 'black', minrange: 0, maxrange: 12, min: 0, index: 0 },\r\n                { text: \"13 à 30\", letter: \"B\", color: \"#dfc1f7\", width: '40%', colortext: 'black', minrange: 13, maxrange: 30, min: 36, index: 1 },\r\n                { text: \"31 à 65\", letter: \"C\", color: \"#d6aaf4\", width: '50%', colortext: 'black', minrange: 31, maxrange: 65, min: 72, index: 2 },\r\n                { text: \"66 à 110\", letter: \"D\", color: \"#cc93f4\", width: '60%', colortext: 'black', minrange: 66, maxrange: 110, min: 108, index: 3 },\r\n                { text: \"111 à 160\", letter: \"E\", color: \"#bb72f3\", width: '70%', colortext: 'black', minrange: 111, maxrange: 160, min: 144, index: 4 },\r\n                { text: \"161 à 220\", letter: \"F\", color: \"#a94cee\", width: '80%', colortext: 'black', minrange: 161, maxrange: 220, min: 180, index: 5 },\r\n                { text: \"> 220\", letter: \"G\", color: \"#8b1ae1\", width: '90%', colortext: 'white', minrange: 220, maxrange: 9999, min: 216, index: 6 },\r\n            ],\r\n            assocGES: [\r\n                { type: 'logement', ref: 'ges', title_haut: 'Faible émission de GES', title_bas: 'Forte émission de GES', typeBatiment: 'Logement' },\r\n                { type: 'tertiaire', ref: 'gesTertiaire', title_haut: 'Faible émission de GES', title_bas: 'Forte émission de GES', typeBatiment: 'Bâtiment' },\r\n                { type: 'public', ref: 'gesPublic', title_haut: 'Faible émission de GES', title_bas: 'Forte émission de GES', typeBatiment: 'Bâtiment' },\r\n                { type: 'bureaux', ref: 'gesBureaux', title_haut: 'Faible émission de GES', title_bas: 'Forte émission de GES', typeBatiment: 'Bâtiment' },\r\n                { type: 'OccContinue', ref: 'gesOccContinue', title_haut: 'Faible émission de GES', title_bas: 'Forte émission de GES', typeBatiment: 'Bâtiment' },\r\n            ],\r\n            widthDaron: 0,\r\n            title_haut: '',\r\n            title_bas: '',\r\n            typeBatiment: ''\r\n        }\r\n    },\r\n    created() {\r\n    },\r\n    destroyed() {\r\n    },\r\n    mounted() {\r\n        let gesfind = this.type ? this.assocGES.find(ass => ass.type == this.type) : this.ges;\r\n        this.type ? this.ges = this[gesfind.ref] : this.ges;\r\n        gesfind = this.type ? this.assocGES.find(ass => ass.type == this.type) : this.fes;\r\n        this.type ? this.ges = this[gesfind.ref] : this.ges;\r\n        let heightCell = (document.getElementById('ges_div').offsetHeight / this[gesfind.ref].length) - 12;\r\n        gesfind ? this.title_haut = gesfind.title_haut : '';\r\n        gesfind ? this.title_bas = gesfind.title_bas : '';\r\n        gesfind ? this.typeBatiment = gesfind.typeBatiment : '';\r\n        let gesrange = this.ges.find(item => item.minrange <= this.value && item.maxrange >= this.value);\r\n        gesrange == undefined ? gesrange = this.ges[this.ges.length - 1] : '';\r\n        this.widthDaron = document.getElementById('ges_div').offsetWidth - 24;\r\n        let DynamicHeight = (gesrange.index * heightCell) + 4 * gesrange.index;\r\n        var r = document.querySelector(':root');\r\n        r.style.setProperty('--heightGES', DynamicHeight + 'px');\r\n        r.style.setProperty('--heightCellGES', heightCell + 'px');\r\n        r.style.setProperty('--heightTriangleGES', heightCell / 2 + 'px');\r\n    },\r\n    computed: {\r\n    },\r\n    methods: {\r\n        exporttopng() {\r\n            var node = document.querySelector(\"#ges_div\");\r\n            let acc = this;\r\n            this.exportMode = ''\r\n            htmlToImage.toPng(node)\r\n                .then(function (dataUrl) {\r\n                    var link = document.createElement('a');\r\n                    var img = new Image();\r\n                    img.src = dataUrl;\r\n                    link.download = 'etiquette.jpeg';\r\n                    link.href = dataUrl;\r\n                    link.click();\r\n                    acc.exportMode = 'active'\r\n                })\r\n                .catch(function (error) {\r\n                    console.error('oops, something went wrong!', error);\r\n                });\r\n        }\r\n    }\r\n}\r\n</script>\r\n<style lang=\"scss\">\r\n:root {\r\n    --heightGES: 0px;\r\n    --heightCellGES: 2rem;\r\n    --heightTriangleGES: 1rem;\r\n}\r\n\r\n\r\n\r\n#ges_div {\r\n    position: relative;\r\n    max-height: fit-content;\r\n    height: fit-content;\r\n    width: 100%;\r\n    display: flex;\r\n\r\n    .space_beetween {\r\n        height: var(--heightGES);\r\n    }\r\n\r\n    .legend_top {\r\n        text-align: initial;\r\n    }\r\n\r\n    .legend_bottom {\r\n        display: flex;\r\n        position: absolute;\r\n        justify-content: space-between;\r\n        width: 100%;\r\n    }\r\n\r\n    .grp-et {\r\n        display: flex;\r\n    }\r\n\r\n    .div_left {\r\n        width: 100%;\r\n        z-index: 5;\r\n    }\r\n\r\n    .div_right {\r\n        display: flex;\r\n        flex-direction: column;\r\n        height: 100%;\r\n        position: relative;\r\n    }\r\n\r\n    .slider_number {\r\n        display: flex;\r\n        align-items: center;\r\n        justify-content: center;\r\n        background-color: black;\r\n        color: white;\r\n        width: 100%;\r\n        z-index: 2;\r\n    }\r\n\r\n    .space_between_class {\r\n        padding: 2px 0px 2px 0px;\r\n    }\r\n\r\n    * {\r\n        margin: 0;\r\n    }\r\n\r\n    .etiquette {\r\n        .etiquette_base {\r\n            height: var(--heightCellGES);\r\n            display: flex;\r\n            align-items: center;\r\n            justify-content: space-between;\r\n            position: relative;\r\n            border: 1px solid;\r\n        }\r\n    }\r\n\r\n    .triangle-leftcode {\r\n        border-top: var(--heightTriangle) solid transparent;\r\n        border-bottom: var(--heightTriangle) solid transparent;\r\n    }\r\n\r\n    .aim_line {\r\n        height: 1px;\r\n        border-style: dotted;\r\n        border-color: black;\r\n        border-width: 1px;\r\n        position: absolute;\r\n        right: 0;\r\n        z-index: 1;\r\n    }\r\n\r\n    .export_div {\r\n        cursor: pointer;\r\n        right: 0;\r\n    }\r\n}\r\n</style>",":root {\n  --heightGES: 0px;\n  --heightCellGES: 2rem;\n  --heightTriangleGES: 1rem;\n}\n\n#ges_div {\n  position: relative;\n  max-height: fit-content;\n  height: fit-content;\n  width: 100%;\n  display: flex;\n}\n#ges_div .space_beetween {\n  height: var(--heightGES);\n}\n#ges_div .legend_top {\n  text-align: initial;\n}\n#ges_div .legend_bottom {\n  display: flex;\n  position: absolute;\n  justify-content: space-between;\n  width: 100%;\n}\n#ges_div .grp-et {\n  display: flex;\n}\n#ges_div .div_left {\n  width: 100%;\n  z-index: 5;\n}\n#ges_div .div_right {\n  display: flex;\n  flex-direction: column;\n  height: 100%;\n  position: relative;\n}\n#ges_div .slider_number {\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  background-color: black;\n  color: white;\n  width: 100%;\n  z-index: 2;\n}\n#ges_div .space_between_class {\n  padding: 2px 0px 2px 0px;\n}\n#ges_div * {\n  margin: 0;\n}\n#ges_div .etiquette .etiquette_base {\n  height: var(--heightCellGES);\n  display: flex;\n  align-items: center;\n  justify-content: space-between;\n  position: relative;\n  border: 1px solid;\n}\n#ges_div .triangle-leftcode {\n  border-top: var(--heightTriangle) solid transparent;\n  border-bottom: var(--heightTriangle) solid transparent;\n}\n#ges_div .aim_line {\n  height: 1px;\n  border-style: dotted;\n  border-color: black;\n  border-width: 1px;\n  position: absolute;\n  right: 0;\n  z-index: 1;\n}\n#ges_div .export_div {\n  cursor: pointer;\n  right: 0;\n}\n\n/*# sourceMappingURL=ges.vue.map */"]}, media: undefined });
