...
var script$1 = {
    ...
    mounted: function mounted() {
        ...
        if (typeof window !== 'undefined') {
            ...
            var DynamicHeight = (gesrange.index * this.heightCell) + 6 * gesrange.index;
            var r = document.querySelector(':root');
